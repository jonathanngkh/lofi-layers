...
#@onready var death_sounds = [
	#preload("res://Characters/female_goblin/sounds/sfx_enemy_roguegoblin_death/sfx_enemy_roguegoblin_death [Draft 2].wav"),
#]
...
func _on_animation_finished() -> void:
	...
	await tween.tween_property(female_goblin, "modulate:a", 0, 1).finished
	female_goblin.queue_free()
