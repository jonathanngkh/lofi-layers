...
#func convert_pitch_to_note_name(pitch_to_convert: int) -> String: # converts 73 into "C#5"
	## Define the note patterns within an octave
	#var notes = ["C", "C#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "A#", "B"]
	#var note_index = (pitch_to_convert - 12) % 12 # Calculate the note index in the 'notes' list
	#var octave = (pitch_to_convert - 12) /12 # Calculate the octave
	#var note_name = "%s%d" % [notes[note_index], octave]
	#return note_name
